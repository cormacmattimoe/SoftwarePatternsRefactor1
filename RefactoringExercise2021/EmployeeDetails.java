...
public class EmployeeDetails extends JFrame implements ActionListener, ItemListener, DocumentListener, WindowListener {
  ...
  public void displayRecords(Employee currentEmployee) {
    ...
    // details
    if (currentEmployee == null) {} else if (currentEmployee.getEmployeeId() == 0) {} else {
  ...
  public void searchEmployeeById() {
    ...
    try {
      // if any active Employee record search for ID else display message that Employee not found
      if (isSomeoneToDisplay()) {
        firstRecord(); 
        int firstId = currentEmployee.getEmployeeId();
        // if ID to search is already displayed else loop through records
        ...
        // If Employee is not found display message 
        if (!found)
    ...
    searchByIdField.setText("");
  } //end method searchEmployeeByID
  

  // search Employee by surname
  public void searchEmployeeBySurname() {
    boolean employeeFound = false;
    // if any active Employee record search for ID 
    if (isSomeoneToDisplay()) {
    ...
    searchBySurnameField.setText("");
  } // end method searchEmployeeBySurname
  ...
  private Employee getChangedDetails() {
    ...
    currentEmployee = new Employee(Integer.parseInt(idField.getText()), ppsField.getText().toUpperCase(),
